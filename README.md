...
SweetPotato by @_EthicalChaos_
  ...
  -e, --exploit=VALUE        Exploit mode [DCOM|WinRM|EfsRpc|PrintSpoofer(default)]
  -l, --listenPort=VALUE     COM server listen port (default 6666)
  -r, --rpcTransport=VALUE   RPC transport [ncalrpc|ncacn_np] (default: ncalrpc)
  -i, --rpcInterface=VALUE   EfsRpc interface [efsrpc|lsarpc] (default: efsrpc)
